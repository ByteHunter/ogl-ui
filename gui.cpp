...
Static::Static(float xpos, float ypos, float zpos, float width, float height, bool vis, const char *txt)
{
	//Position
	x = xpos;
	y = ypos;
...
Button::Button(float xpos, float ypos, float zpos, float width, float height, bool vis, const char *txt)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
void Button::Render(void)
{
	...
	//Render border
	if(state==0) glColor3f(0.6f,0.6f,0.6f);
	if(state==1) glColor3f(0.4f,0.4f,0.4f);
...
Frame::Frame(float xpos, float ypos, float zpos, float width, float height, bool vis, const char *txt)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
void Frame::AddControl(void *_pcontrol)
{
	child_controls.push_back(_pcontrol);
}
...
int Frame::LDown(float xpos, float ypos)
{
	if(!visible)
		return 0;
	if(!((xpos>=x)&&(xpos<=(x+w))&&(ypos>=y)&&(ypos<=(y+hh))))
	{
		return 0;
	}
	else
...
Edit::Edit(float xpos, float ypos, float zpos, float width, float height, bool vis, const char *txt)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
CheckBox::CheckBox(float xpos, float ypos, float zpos, float width, float height, bool vis, const char *txt)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
EditNumber::EditNumber(float xpos, float ypos, float zpos, float width, float height, bool vis, int val)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
void EditNumber::Render(void)
{
	...
	glEnd();
	//Left
	if(lstate==0) glColor3f(0.05f,0.05f,0.05f);
	if(lstate==1) glColor3f(0.15f,0.15f,0.15f);
	if(lstate==2) glColor3f(0.05f,0.05f,0.05f);
	glBegin(GL_POLYGON);
	glVertex3f(x,y+b,z);
	glVertex3f(x+b,y,z);
	glVertex3f(x+20,y,z);
	...
	glEnd();
	//Right
	if(rstate==0) glColor3f(0.05f,0.05f,0.05f);
	if(rstate==1) glColor3f(0.15f,0.15f,0.15f);
	if(rstate==2) glColor3f(0.05f,0.05f,0.05f);
	glBegin(GL_POLYGON);
	...
	glEnd();
	//left
	if(lstate==0) glColor3f(0.6f,0.6f,0.6f);
	if(lstate==1) glColor3f(0.4f,0.4f,0.4f);
	if(lstate==2) glColor3f(0.8f,0.8f,0.8f);
	glBegin(GL_LINE_LOOP);
	glVertex3f(x,y+b,z+0.01f);
	glVertex3f(x+b,y,z+0.01f);
	glVertex3f(x+20,y,z+0.01f);
	...
	glEnd();
	//right
	if(rstate==0) glColor3f(0.6f,0.6f,0.6f);
	if(rstate==1) glColor3f(0.4f,0.4f,0.4f);
	if(rstate==2) glColor3f(0.8f,0.8f,0.8f);
	glBegin(GL_LINE_LOOP);
	glVertex3f(x+w-20,y,z+0.01f);
	glVertex3f(x+w,y,z+0.01f);
	glVertex3f(x+w,y+h-5,z+0.01f);
	...
	if(lstate==1) glColor3f(0.4f,0.4f,0.4f);
	if(lstate==2) glColor3f(0.8f,0.8f,0.8f);
	glVertex3f(x+5+((lstate==1)?1:0),y+h/2+((lstate==1)?1:0),z+0.01f);
	glVertex3f(x+15+((lstate==1)?1:0),y+h/2+((lstate==1)?1:0),z+0.01f);
	//plus
	if(rstate==0) glColor3f(0.6f,0.6f,0.6f);
	if(rstate==1) glColor3f(0.4f,0.4f,0.4f);
	if(rstate==2) glColor3f(0.8f,0.8f,0.8f);
	glVertex3f(x+w-15+((rstate==1)?1:0),y+h/2+((rstate==1)?1:0),z+0.01f);
	glVertex3f(x+w-5+((rstate==1)?1:0),y+h/2+((rstate==1)?1:0),z+0.01f);
	glVertex3f(x+w-10+((rstate==1)?1:0),y+5+((rstate==1)?1:0),z+0.01f);
	glVertex3f(x+w-10+((rstate==1)?1:0),y+15+((rstate==1)?1:0),z+0.01f);
	glEnd();
...
int EditNumber::LDown(float xpos, float ypos)
{
	...
	//check right
	if(((xpos>=(x+w-20))&&(xpos<=(x+w))&&(ypos>=y)&&(ypos<=(y+h))))
	//{
		//return 0;
	//}
	//else
...
EditNumberF::EditNumberF(float xpos, float ypos, float zpos, float width, float height, bool vis, float val, float _min, float _max, float _step)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
Slider::Slider(float xpos, float ypos, float zpos, float width, float height, bool vis, int _val, int _min, int _max, int _step)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
void Slider::Render(void)
{
	...
	//Draw button
	if(state==0) glColor3f(0.05f,0.05f,0.05f);
	if(state==1) glColor3f(0.2f,0.2f,0.2f);
	if(state==2) glColor3f(0.1f,0.1f,0.1f);
	glBegin(GL_POLYGON);
	...
	glEnd();
	if(state==0) glColor3f(0.5f,0.5f,0.5f);
	if(state==1) glColor3f(0.4f,0.4f,0.4f);
	if(state==2) glColor3f(0.8f,0.8f,0.8f);
	glBegin(GL_LINE_LOOP);
...
Wheel::Wheel(float xpos, float ypos, float zpos, float width, float height, bool vis, float _val, float _min, float _max, float _step)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
void Wheel::Render(void)
{
	...
	for(int i=0; i<9; i++){
		glColor3d(cos((10*i)*PI180)*cos((10*i)*PI180)*0.2,cos((10*i)*PI180)*cos((10*i)*PI180)*0.2,cos((10*i)*PI180)*cos((10*i)*PI180)*0.2);
		glVertex3d(x+w/2+(w/2-b)*sin((10*i)*PI180),y+b,z-0.01f);
		glVertex3d(x+w/2+(w/2-b)*sin((10*i)*PI180),y+h-b,z-0.01f);
	}
	glEnd();
	glBegin(GL_QUAD_STRIP);
	glColor3f(0.2f,0.2f,0.2f);
	...
	if(state==2) glColor3f(0.8f,0.8f,0.8f);
	for(int i=0; i<9; i++){
		glVertex3d(x+w/2+(w/2-b)*sin((10*i+delta)*PI180),y+b,z);
		glVertex3d(x+w/2+(w/2-b)*sin((10*i+delta)*PI180),y+h-b,z);
		glVertex3d(x+w/2-(w/2-b)*cos((10*i+delta)*PI180),y+b,z);
		glVertex3d(x+w/2-(w/2-b)*cos((10*i+delta)*PI180),y+h-b,z);
	}
	glEnd();
...
{
	if(!visible) return 0;
	if((xpos>=(x+b))&&(xpos<=(x+w-b))&&(ypos>=(y+b))&&(ypos<=(y+h-b))){
		mleft = true;
		state = 1;
		x0 = xpos;
		SetCursor(LoadCursor(NULL,IDC_HAND));
...
Tabs::Tabs(float xpos, float ypos, float zpos, float width, float height, bool vis, int numtabs)
{
	x = xpos;
	y = ypos;
	z = zpos;
...
{
	if(tab<0) return;
	if(TabFrameControls.empty()) return;
...
void Tabs::Render(void)
{
	...
	for(unsigned int i=0;i<TabNames.size();i++){
		if(current_tab!=i){
			if(mousein!=i) glColor3f(0.15f,0.15f,0.15f);
...
int Tabs::LDown(float xpos, float ypos)
{
	...
	for(unsigned int i=0;i<TabNames.size();i++){
		if((xpos>=(x+twidth*i))&&(xpos<=(x+twidth*(i+1)))&&(ypos>=(y))&&(ypos<=(y+theight))){
			insideof = i;
		}
	}
	//If mouse is over any tab but currnet one can be clicked but not changed until mouse button is released
...
int Tabs::LUp(float xpos, float ypos)
{
	...
	//Now if mouse button was released inside a tab (selector region) can be selected this tab
