...
public:
  // Main functions
  Static(void);
  Static(float xpos, float ypos, float zpos, float width, float height,
...
public:
  // Main functions
  Button(void);
  Button(float xpos, float ypos, float zpos, float width, float height,
         bool vis, const char *txt);
  void SetText(const char *txt);
  void Render(void);
...
public:
  ...
  // Main functions
  Frame(void);
  Frame(float xpos, float ypos, float zpos, float width, float height, bool vis,
        const char *txt);
  void SetText(const char *txt);
...
public:
  // Main functions
  Edit(void);
  Edit(float xpos, float ypos, float zpos, float width, float height, bool vis,
       const char *txt);
  void SetText(const char *txt);
  void Render(void);
...
public:
  // Main functions
  CheckBox(void);
  CheckBox(float xpos, float ypos, float zpos, float width, float height,
           bool vis, const char *txt);
  void SetText(const char *txt);
  void Render(void);
...
public:
  ...
  // Main functions
  EditNumber(void);
  EditNumber(float xpos, float ypos, float zpos, float width, float height,
             bool vis, int val);
  void SetText(const char *txt);
  void Render(void);
...
public:
  ...
  // Main functions
  EditNumberF(void);
  EditNumberF(float xpos, float ypos, float zpos, float width, float height,
              bool vis, float val, float _min, float _max, float _step);
  void SetText(const char *txt);
  void Render(void);
...
public:
  ...
  // Main functions
  Slider(void);
  Slider(float xpos, float ypos, float zpos, float width, float height,
...
public:
  ...
  // Main functions
  Wheel(void);
  Wheel(float xpos, float ypos, float zpos, float width, float height, bool vis,
        float _val, float _min, float _max, float _step);
  void SetText(const char *txt);
  void Render(void);
...
public:
  ...
  // Main functions
  Tabs(void);
  Tabs(float xpos, float ypos, float zpos, float width, float height, bool vis,
       int numtabs);
